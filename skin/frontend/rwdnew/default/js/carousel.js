   ...
   document.addEventListener("DOMContentLoaded", function () {
     ...
     $('#header-search-button'). click( function () {
       $('.search-hidden').toggleClass('show')
     })

     // links
      $('.top_links').click( function (event) {
        $('.user-links').toggleClass('show-links')
      })
    ...
    var multiItemSlider = (function () {
      ...
      return function (selector, config) {
        ...
        if (_mainElement) {
          ...
          console.log('wadasdad ' + _items.length);
          ...
          var _transformItem = function (direction) {
            ...
            if (direction === 'right') {
              ...
              if ((_positionLeftItem + _wrapperWidth / _itemWidth - 1) > position.getMax()) {
                ...
                _items[nextItem].transform += _items.length * 100 + 110;
                console.log(_items[nextItem].transform);
            ...
            if (direction === 'left') {
              ...
              if (_positionLeftItem < position.getMin()) {
                ...
                _items[nextItem].transform -= _items.length * 100 + 139;
                _items[nextItem].item.style.transform = 'translateX(' + _items[nextItem].transform + '%)';
              }
              _transform += _step;
            }
